...
And at the end, I'll share a [personal story](#how-things-can-still-go-wrong---a-cautionary-tale) to illustrate how despite following best practices, you might still not end up with what you expect.
...
Obviously, there's no way to concretely quantify the risk here. Robert Heaton [has a great article on this](https://robertheaton.com/2015/11/02/how-to-value-your-startup-stock-options/). He outlines a series of discounts to apply (common stock discount, strike price discount, mobility discount, risk discount, liquidity discount) and ultimately concludes that **valuing options at ~20% their nominal value is reasonable**.
...
The best tool I know is [Index Venture's Option Plan](https://www.indexventures.com/optionplan/), which lets you filter by country, stage, how technical the role is, and how many funding rounds are planned. Put your own numbers in - it's most useful when personalised to your situation.
...
[Others](https://www.amazon.co.uk/dp/B07T7L39TN/) [have](https://www.kalzumeus.com/2012/01/23/salary-negotiation/) [written](https://www.classcentral.com/course/linkedin-learning-nano-tips-for-negotiating-your-salary-with-sho-dewan-101330) about negotiation, but a few principles worth keeping in mind:
